...
<<<<<<< HEAD
    ...
    UITapGestureRecognizer *openMobVersion = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(openMobVersion)];
...
>>>>>>> FETCH_HEAD
    ...
    if ([version floatValue]<7)
    {
        ...
        [rightCustomButton setTitle:@"Site" forState:UIControlStateNormal];
...
>>>>>>> FETCH_HEAD
    ...
    webUrl.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:14];
...
-(void)talkToUs
{
    ...
    [self setTitle:@"Home"];
    NSLog(@"desc %@",self.navigationController);
...
-(void)lastVisitDetails:(NSMutableDictionary *)visits
{
    ...
    if(visits != NULL)
    {
        ...
        if(!isAlertViewSet)
        {
         ...
         [self customalert:[NSString stringWithFormat:@"%@, %@",cityName,countryName] Seen:[NSString stringWithFormat:@"visited %@",lastSeen] category:3];
            isAlertViewSet = YES;
    ...
    {
        [self customalert:@"Oops! Something went wrong" Seen:@"" category:1];
    }
...
>>>>>>> FETCH_HEAD
    ...
    webUrl.frame = CGRectMake(110, 68, 200, 60);
...
-(void)customalert:(NSString*)SeenContry Seen:(NSString*)lastSeen category:(int)type
{
    ...
    else if(type==2)
    {
        ...
        vistedLabel.frame =CGRectMake(205, 20, 200, 20);
        vistedLabel.text =@"Nowfloats Boost";
